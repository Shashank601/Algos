...
A Node is a state representing a prefix its children are all possible next prefixes.
curr->arr[c - 'a'] = new Node(); // just put a empty node at that idx  to mark char presence
